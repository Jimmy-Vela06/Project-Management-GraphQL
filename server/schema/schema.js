...
const mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    deleteClient: {
      ...
      resolve(parent, args) {
        return Client.findByIdAndRemove(args.id); // DELETES CLIENT BY FINDING CLIENT ID
      },
    },
    // ADD A PROJECT
    addProject: {
      ...
      resolve(parent, args) {
        ...
        return Project.create(project); //CREATES NEW PROJECT WITH ID, NAME, DISCRIPTION, STATUS, AND CLIENT INFO
      },
    },
    deleteProject: {
      type: ProjectType,
      ...
      resolve(parent, args) {
        return Project.findByIdAndRemove(args.id); // DELETES PROJECT BY FINDING PROJECT ID
      },
    },
    // UPDATE A PROJECT
    updateProject: {
      ...
      resolve(parent, args) {
        // FINDS A PROJECT BY ID AND UPDATES THE 'args (name, description, status)'
        return Project.findByIdAndUpdate(
          ...
          { new: true } // IF ITS NOT EXISTING THEN IT CREATES NEW PROJECT
        );
      },
    },
  },
